...
<select id="logoTypeSelect">
    <option class="select logo" value="select" <?php if ($row['logoType'] == 'select') echo 'selected'; ?>>select</option>
    ...
    <label for="logoFile" class="logoFile"><?php echo $row['logoFile']?></label><br>
