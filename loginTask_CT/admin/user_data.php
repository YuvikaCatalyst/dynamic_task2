...
if ($result->num_rows >=0) {
  $sql = "INSERT INTO websitedata (logoType, logoFile, logoText, navItem1, navItem2, navItem3, navItem4, navItem5, navItem6, navItem7, navItem8, anchor1, anchor2, section1img, section2heading, section2para, anchor3, section2img1, section2img1heading, section2img1para, section2img2, section2img2heading, section2img2para, section2img3, section2img3heading, section2img3para) 
  VALUES ('$logoType', '$logoFile', '$logoText', '$navItem1', '$navItem2', '$navItem3', '$navItem4', '$navItem5', '$navItem6', '$navItem7', '$navItem8', '$anchor1', '$anchor2', '$section1img', '$section2heading', '$section2para', '$anchor3', '$section2img1', '$section2img1heading', '$section2img1para', '$section2img2', '$section2img2heading', '$section2img2para', '$section2img3', '$section2img3heading', '$section2img3para')";
...
if($result->num_rows >0){
    ...
    if(!empty($logoFile) ){
        $sql="UPDATE websitedata SET logoType='$logoType',
         ...
         anchor3='$anchor3',
         section2img1='$section2img1',
         section2img1heading='$section2img1heading',
         section2img1para='$section2img1para',
         section2img2='$section2img2',
         section2img2heading='$section2img2heading',
         section2img2para='$section2img2para',
         section2img3='$section2img3',
         section2img3heading='$section2img3heading',
         section2img3para='$section2img3para'";
